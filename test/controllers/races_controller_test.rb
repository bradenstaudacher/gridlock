...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { location: @race.location, name: @race.name, start_time: @race.start_time, track_name: @race.track_name } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { location: @race.location, name: @race.name, start_time: @race.start_time, track_name: @race.track_name } }
