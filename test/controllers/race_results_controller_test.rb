...
class RaceResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race_result" do
    assert_difference('RaceResult.count') do
      post race_results_url, params: { race_result: { driver_id: @race_result.driver_id, points: @race_result.points, position: @race_result.position, race_id: @race_result.race_id } }
    end
  ...
  test "should update race_result" do
    patch race_result_url(@race_result), params: { race_result: { driver_id: @race_result.driver_id, points: @race_result.points, position: @race_result.position, race_id: @race_result.race_id } }
